...
const config = {
    serverInfo: {
        ...
        serverName: "CreaSpace", /*Server name*/
        serverIp: "CreaSpace", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1275306979312795780" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
